...
public class REset_Password_SD {
	...
	public void admin_clicks_reset_password_link_on_login_page() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("Admin enters valid New Password {string} and  Retype  {string} and gets the result {string}")
	public void admin_enters_valid_new_password_and_retype_and_gets_the_result(String string, String string2, String string3) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	@Then("Admin  verify the message as {string}")
	public void admin_verify_the_message_as(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
...
*/
	@When("Admin enters invalid New Password {string} and  Retype  {string} and gets the result {string}")
	public void admin_enters_invalid_new_password_and_retype_and_gets_the_result(String string, String string2, String string3) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
